...
export function LevelComparisonChart({ days, byLevel }: Props) {
  ...
  return (
    <Card
      className={cn(
        cantinePlusChartCardClass,
        "border-2 border-sky-400 shadow-sky-400/15",
      )}
    >
        ...
        <header className="border-b-2 border-sky-400">
          <div className="flex flex-col md:flex-row md:items-stretch md:gap-0">
            <div className="relative flex shrink-0 items-center self-stretch overflow-hidden bg-[#06101c] py-5 pl-14 pr-6 sm:pl-16 md:pl-20 md:pr-8">
              ...
              >
                <GraduationCap
                  className="absolute right-0 top-1/2 h-28 w-28 -translate-y-1/2 text-sky-300/30 sm:h-32 sm:w-32 md:h-36 md:w-36"
                  strokeWidth={1.25}
                />
              </div>
            ...
            <div
              className="hidden w-px shrink-0 self-stretch bg-sky-400/80 md:block"
              aria-hidden
            />
            <div className="h-px w-full shrink-0 bg-sky-400/80 md:hidden" aria-hidden />
            ...
            <div className="min-w-0 space-y-2 px-6 py-5 md:flex-1 md:pl-6 md:pr-0">
              ...
              <p className="text-sm leading-relaxed text-white/70 sm:text-base">
                ...
                taux en % ·{" "}
                <strong className="font-semibold text-white">service</strong> =
                servis / présents ·{" "}
                <strong className="font-semibold text-white">RAB</strong> et{" "}
                <strong className="font-semibold text-white">refus</strong> = vs
                assiettes servies.
              </p>
              <p className="text-sm leading-relaxed text-white/70 sm:text-base">
